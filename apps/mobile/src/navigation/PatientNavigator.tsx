...
import { VideoConsultationsScreen } from '../screens/patient/VideoConsultationsScreen';
...
export const PatientNavigator: React.FC = () => (
  <Stack.Navigator screenOptions={{ headerBackTitle: 'Back' }}>
    ...
    <Stack.Screen name="PatientKycAadhaarUpload" component={PatientKycAadhaarScreen} options={{ title: 'Aadhaar Verification' }} />
