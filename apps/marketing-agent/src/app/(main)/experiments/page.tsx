    ...
    <div className="space-y-6">
        ...
        <Card title="Key Learnings" subtitle="Decisions made from completed experiments">
          <div className="space-y-2">
            <div className="p-3 bg-green-50 border border-green-200 rounded-lg text-sm text-green-700">
              <strong>Landing page hero:</strong> Benefit-led copy (&ldquo;Get started in 30 seconds&rdquo;) outperforms feature-led copy (+14% signup-start rate). <strong>Apply to all landing pages.</strong>
            </div>
            <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-700">
              <strong>Email subject line:</strong> Discount-led subject (&ldquo;Your credit is waiting&rdquo;) outperforms FOMO subject (+4pp open rate). <strong>Use discount framing for onboarding emails.</strong>
            </div>
          </div>
        </Card>
      )}
      ...
      <Card title="📋 Experiment Design Template" subtitle="Use this structure when designing a new A/B test">
        <div className="space-y-2 text-sm text-gray-700">
          {[
            { field: 'Experiment Name', example: 'e.g. Meta Creative — Founder Photo vs Customer Story' },
            { field: 'Hypothesis', example: 'e.g. Customer story video will drive higher CTR than founder photo static ad' },
            { field: 'Channel', example: 'e.g. Meta Ads' },
            { field: 'Control (A)', example: 'e.g. Static image: founder with rating overlay' },
            { field: 'Variant (B)', example: 'e.g. 20-second customer testimonial video' },
