...
export const intakeQuestions: IntakeQuestion[] = [
  // Tier 1
  {
    ...
    tier: 1,
    question: 'Who is the primary audience you are growing right now?',
    type: 'select',
    options: ['Customers', 'Partners', 'Both simultaneously'],
  },
  {
    ...
    type: 'select',
    options: ['Supply (not enough partners/inventory)', 'Demand (not enough customers)', 'Activation (users sign up but don\'t transact)'],
  },
  {
    id: 'monthlyBudget',
    tier: 1,
  ...
  },
  {
    id: 'targetCities',
    tier: 1,
    question: 'Which 2-3 markets are you focusing on for the next 90 days?',
    type: 'multiselect',
    options: ['Mumbai', 'Delhi', 'Bengaluru', 'Hyderabad', 'Chennai', 'Pune', 'Kolkata', 'Ahmedabad', 'New York', 'London', 'Singapore', 'Remote / Online'],
  },
  {
    id: 'bestPerforming',
    tier: 1,
  ...
  // Tier 2
  {
    id: 'topCustomerPersona',
    tier: 2,
    question: 'Who is your most valuable customer persona (age, role/need, income, digital fluency)?',
    type: 'textarea',
    placeholder: 'e.g. Urban professional, 28-38, time-poor, high income, tech-savvy',
  },
  {
    id: 'topReasonCustomerChooses',
    tier: 2,
    question: 'What is the #1 reason a customer chooses your brand over an alternative?',
    type: 'textarea',
    placeholder: 'e.g. Speed of service, price transparency, quality of vetted partners',
  },
  {
    id: 'topReasonPartnerJoins',
    tier: 2,
    question: 'What is the #1 reason a partner / supplier joins and stays on your platform?',
    type: 'textarea',
    placeholder: 'e.g. Steady demand flow, no upfront cost, easy payment processing',
  },
  {
    id: 'topCompetitors',
    tier: 2,
    ...
    type: 'textarea',
    placeholder: 'e.g. Competitor A — we beat them on speed; Competitor B — we offer real-time tracking',
  },
  {
    id: 'founderLedBrand',
    tier: 2,
  ...
  // Tier 3
  {
    ...
    type: 'textarea',
    placeholder: 'e.g. New competitor launched in our key market, we shipped a new feature',
  },
  {
    id: 'lastExperiments',
    tier: 3,
...
export const contentPillarMeta: Record<ContentPillar, { label: string; color: string; icon: string }> = {
  'audience-education': { label: 'Audience Education', color: 'bg-blue-100 text-blue-700', icon: '📚' },
  'partner-spotlight': { label: 'Partner Spotlight', color: 'bg-purple-100 text-purple-700', icon: '⭐' },
  ...
  'local-community': { label: 'Local & Community', color: 'bg-red-100 text-red-700', icon: '🏙️' },
};
...
export const marketingSkills: MarketingSkill[] = [
  ...
  },
  {
    ...
    examplePrompt: 'Set up GA4 + Meta Pixel event tracking for your conversion funnel — list every event, parameter, and where to fire it.',
  },
  ...
  // Paid & Distribution
  {
    ...
    examplePrompt: 'Generate 10 Meta ad creative variations for a customer-acquisition campaign — headlines, primary text, and visual direction.',
  },
  {
    id: 'paid-ads',
    name: 'Paid Ads',
    ...
    examplePrompt: 'Plan a Google Search campaign for your brand — campaign structure, keyword themes, bidding, and negatives.',
  },
  ...
  // SEO & Discovery
  {
    ...
    examplePrompt: 'Optimize your top product page so it gets cited by ChatGPT and Perplexity for relevant queries.',
  },
  {
    id: 'seo-audit',
    name: 'SEO Audit',
  ...
  },
  {
    ...
    examplePrompt: 'Design a programmatic SEO template for "[category] in [city]" landing pages for your brand.',
  },
  {
    ...
    examplePrompt: 'Propose an information architecture for example.com that supports customers, partners, and SEO long-tail.',
  },
  {
  ...
  },
  {
    ...
    examplePrompt: 'Generate JSON-LD schema for your top product/service page (Product + Offer + AggregateRating).',
  },
  {
    id: 'aso-audit',
    name: 'ASO Audit',
    ...
    examplePrompt: 'Audit your top app store listing — title, subtitle, screenshots, keywords, and conversion improvements.',
  },
  ...
  // Retention
  {
    ...
    examplePrompt: 'Design a 4-step cancellation save-flow for your customers with personalised offers and surveys.',
  },
  ...
  // Content & Copy
  {
    ...
    examplePrompt: 'Write a 4-step cold email sequence to corporate buyers pitching your brand for their team or organisation.',
  },
  {
    id: 'copywriting',
    name: 'Copywriting',
  ...
  },
  {
    ...
    examplePrompt: 'Edit this draft of our LinkedIn partner-recruitment post for clarity, brevity, and tone.',
  },
  {
    id: 'email-sequence',
    name: 'Email Sequence',
    ...
    examplePrompt: 'Build a 7-email customer onboarding sequence for your brand — goal: first transaction within 14 days.',
  },
  {
    id: 'social-content',
    name: 'Social Content',
    ...
    examplePrompt: 'Draft 5 LinkedIn posts about your brand’s core offering — mix of education, story, and CTA.',
  },
  ...
  // Conversion Optimization
  {
    ...
    examplePrompt: 'Audit your primary conversion landing page and propose 8 prioritised CRO experiments.',
  },
  {
    id: 'signup-flow-cro',
    ...
    examplePrompt: 'Reduce friction in your customer signup flow — current drop-off is 38% on phone-OTP step.',
  },
  {
    id: 'onboarding-cro',
    name: 'Onboarding CRO',
    ...
    examplePrompt: 'Redesign your brand first-run onboarding to lift signup→first-transaction from 28% to 40%.',
  },
  {
    id: 'form-cro',
    name: 'Form CRO',
    ...
    examplePrompt: 'Improve your enterprise enquiry form — 12 fields today, 4% completion rate.',
  },
  {
    id: 'popup-cro',
    name: 'Popup CRO',
    ...
    examplePrompt: 'Design an exit-intent popup for your pricing page that captures email + offers a discount.',
  },
  {
    ...
    examplePrompt: 'Design an in-app upgrade screen prompting your customers to subscribe to the annual plan.',
  },
  ...
  // Customer & Strategy
  {
    ...
    examplePrompt: 'Plan 8 customer interviews with your brand active customers — recruitment script, questions, and synthesis template.',
  },
  {
    id: 'content-strategy',
  ...
  },
  {
    ...
    examplePrompt: 'Plan a launch for your brand’s new feature/product line — channels, sequence, and assets.',
  },
  {
    id: 'marketing-ideas',
    ...
    examplePrompt: 'Give me 20 unconventional growth ideas for your brand — specifically for your top market.',
  },
  {
  ...
  },
  {
    ...
    examplePrompt: 'Propose a 3-tier pricing/packaging model for your brand subscriptions.',
  },
  {
  ...
  // Growth Engineering
  {
    ...
    examplePrompt: 'Design a free "ROI calculator" tool for your brand to drive organic traffic and email signups.',
  },
  {
    id: 'lead-magnets',
    name: 'Lead Magnets',
    ...
    examplePrompt: 'Create a downloadable "Quick-start Guide" lead magnet for your brand — outline + landing page copy.',
  },
  {
    id: 'referral-program',
    ...
    examplePrompt: 'Design a 2-sided referral program for your brand customers — incentives, mechanics, and launch plan.',
  },
  {
    ...
    examplePrompt: 'Launch your customer community on WhatsApp + Reddit — name, content plan, and 30-day calendar.',
  },
  ...
  // Sales & RevOps
  {
    ...
    examplePrompt: 'Design a lead-scoring + routing model for your brand’s enterprise (B2B) pipeline.',
  },
  {
    id: 'sales-enablement',
    ...
    examplePrompt: 'Create a 10-slide pitch deck for your brand enterprise sales calls.',
  },
];
...
// because they don't fit the brand's current B2C / subscription focus
...
**🔴 Priority 1: Partner / Supply (Critical)**
Your active partner count is at 148 vs a target of 200. This is the #1 constraint on your growth — you cannot acquire more customers if supply can't absorb demand.
→ **Action:** Launch the LinkedIn partner-recruitment campaign this week. Use the brief in the Campaigns section.

**🟡 Priority 2: Conversion Rate (At Risk)**
Only 28% of signups complete a first transaction within 7 days vs your 35% target. The Day 3 incentive email in your onboarding flow has the highest leverage here.
...
Referrals are only 9% of new signups vs 15% target. The post-purchase referral ask is the easiest lever.
→ **Action:** Add a referral CTA to your post-purchase confirmation screen. This is a 1-day engineering task with high ROI.

Want me to draft the partner-recruitment ad copy or the referral screen copy?`,
    timestamp: '09:01',
  },
];
