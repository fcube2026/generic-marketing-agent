-- Dev seed: 4 demo providers near Delhi (28.6139, 77.2090) with all modes enabled,
-- linked to every existing service category. Idempotent.

BEGIN;

-- Users (PROVIDER role)
INSERT INTO users (id, phone, role, "isActive", "createdAt", "updatedAt") VALUES
  ('demo-user-1', '+919000000001', 'PROVIDER', true, NOW(), NOW()),
  ('demo-user-2', '+919000000002', 'PROVIDER', true, NOW(), NOW()),
  ('demo-user-3', '+919000000003', 'PROVIDER', true, NOW(), NOW()),
  ('demo-user-4', '+919000000004', 'PROVIDER', true, NOW(), NOW())
...
-- Link every demo provider to every service category
